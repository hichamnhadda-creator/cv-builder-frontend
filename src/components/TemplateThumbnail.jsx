...
import { getMockDataForTemplate } from '../utils/mockProfiles';

const TemplateThumbnail = ({ templateId, categoryId }) => {
    const { t } = useTranslation();
    const containerRef = useRef(null);
    const [scale, setScale] = useState(1);
    
    // Mock data for the preview
    const mockData = getMockDataForTemplate(templateId, categoryId, t);
    ...
    const templateCustomizations = {
        ...
        'modern-8': { colors: { primary: '#2563eb', secondary: '#1e293b' }, fonts: { heading: 'Poppins', body: 'Inter' } },
        ...
        'creative-8': { colors: { primary: '#0f172a', secondary: '#334155' }, fonts: { heading: 'Poppins', body: 'Inter' } },
        ...
        // New Additions
        'designer-11': { colors: { primary: '#0d9488', secondary: '#111827' }, fonts: { heading: 'Inter', body: 'Inter' } },
        'executive-11': { colors: { primary: '#1e3a8a', secondary: '#475569' }, fonts: { heading: 'Georgia, serif', body: 'Inter' } },
    };
