...
const Modern6 = ({ data, customization }) => {
    ...
    return (
        <div className="min-h-full bg-slate-50 text-slate-800 overflow-hidden font-sans" style={{ fontFamily }}>
            {/* Header */}
            <div className="bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-b-3xl py-10 px-8 shadow-lg" style={{ 
