...
const Modern7 = ({ data, customization }) => {
    ...
    return (
        <div className="min-h-full bg-gradient-to-br from-cyan-50 to-blue-100 text-slate-800 overflow-hidden font-sans" style={{ fontFamily }}>
            {/* Header */}
            <div className="bg-white/40 backdrop-blur-md border-b border-white/50 text-slate-900 py-8 px-8" style={{ 
            ...
            <div className="max-w-4xl mx-auto p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2 space-y-8">
                    ...
                    {personalInfo?.summary && (
                        <div className="bg-white/60 backdrop-blur-lg rounded-2xl shadow-sm border border-white/50 p-6">
