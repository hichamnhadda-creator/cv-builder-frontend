...
const Creative7 = ({ data, customization }) => {
    ...
    return (
        <div className="min-h-full bg-gray-50 text-gray-800 overflow-hidden font-sans" style={{ fontFamily }}>
            {/* Header */}
            <div className="bg-rose-500 text-white clip-path-polygon" style={{ 
            ...
            <div className="max-w-4xl mx-auto p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2 space-y-8">
                    ...
                    {personalInfo?.summary && (
                        <div className="bg-white shadow-md p-6 border-t-4 border-rose-500">
