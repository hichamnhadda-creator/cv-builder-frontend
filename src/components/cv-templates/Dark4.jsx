...
const Dark4 = ({ data, customization }) => {
    ...
    return (
        <div className="min-h-full bg-gray-900 text-gray-100 overflow-hidden font-sans" style={{ fontFamily }}>
            {/* Header */}
            <div className="bg-gray-800 text-white border-b border-gray-700" style={{ 
            ...
            <div className="max-w-4xl mx-auto p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2 space-y-8">
                    ...
                    {personalInfo?.summary && (
                        <div className="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-6">
                            <h3 className="text-2xl font-bold mb-4 pb-2 border-b border-gray-700" style={{ fontFamily: headingFont }}>{t('editor.sections.summary')}</h3>
                    ...
                    {experience?.length > 0 && (
                        <div className="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-6">
                            <h3 className="text-2xl font-bold mb-4 pb-2 border-b border-gray-700" style={{ fontFamily: headingFont }}>{t('editor.sections.experience')}</h3>
                    ...
                    {education?.length > 0 && (
                        <div className="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-6">
                            <h3 className="text-2xl font-bold mb-4 pb-2 border-b border-gray-700" style={{ fontFamily: headingFont }}>{t('editor.sections.education')}</h3>
                            <div className="space-y-6">
                ...
                <div className="space-y-8">
                    ...
                    {skills?.length > 0 && (
                        <div className="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-6">
                            <h3 className="text-2xl font-bold mb-4 pb-2 border-b border-gray-700" style={{ fontFamily: headingFont }}>{t('editor.sections.skills')}</h3>
                    ...
                    {languages?.length > 0 && (
                        <div className="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-6">
                            <h3 className="text-2xl font-bold mb-4 pb-2 border-b border-gray-700" style={{ fontFamily: headingFont }}>{t('editor.sections.languages')}</h3>
                    ...
                    {certifications?.length > 0 && (
                        <div className="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-6">
                            <h3 className="text-2xl font-bold mb-4 pb-2 border-b border-gray-700" style={{ fontFamily: headingFont }}>{t('editor.sections.certifications')}</h3>
