    ...
    const footerLinks = [
        {
            ...
            links: [
                { name: t('nav.templates', 'Templates'), href: ROUTES.TEMPLATES },
                { name: t('nav.pricing', 'Pricing'), href: ROUTES.PRICING },
                { name: t('nav.dashboard', 'Dashboard'), href: ROUTES.DASHBOARD },
            ],
        },
        {
            title: t('footer.support', 'Support'),
            links: [
                { name: t('footer.contact', 'Contact'), href: ROUTES.CONTACT },
                { name: t('footer.refundPolicy', 'Refund Policy'), href: ROUTES.REFUND },
            ],
        },
        {
            title: t('footer.legal', 'Legal'),
            links: [
                { name: t('footer.privacyPolicy', 'Privacy Policy'), href: ROUTES.PRIVACY },
                { name: t('footer.termsOfService', 'Terms of Service'), href: ROUTES.TERMS },
            ],
        },
    ];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
                    ...
                    <div className="md:col-span-2 lg:col-span-2">
                        ...
                        <p className="text-[#475569] text-lg font-medium leading-relaxed mb-8 max-w-sm">
                            {t('footer.description', 'The intelligent way to build your professional career. Create AI-powered resumes that get you hired at top companies.')}
                        </p>
                ...
                <div className="pt-8 border-t border-[#e2e8f0] flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="text-[#64748b] text-[15px] font-medium order-2 md:order-1">
                        © {currentYear} <span className="text-[#0f172a] font-bold">{APP_NAME}</span>. {t('footer.craftedFor', 'Crafted for modern careers.')}
                    </div>
                    
                    <div className="flex items-center gap-8 order-1 md:order-2">
                        <a 
                            href="mailto:hichamnhadda@gmail.com" 
